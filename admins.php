...
if (isset($_GET['adminsDelete'])) {
 ...
 $sonuc=$db->delete("admins","admins_id",$_GET['admins_id']);
    ...
    <tbody id="sortable">
      ...
      while ($row=$sql->fetch(PDO::FETCH_ASSOC)) {  ?>
        ...
        <tr id="item-<?php echo $row['admins_id'] ?>">
          ...
          <td align="center" width="5"><a href="?adminsDelete=True&admins_id=<?php echo $row['admins_id'] ?>"><i class="fa fa-trash-o"></i></a></td>
        </tr>
